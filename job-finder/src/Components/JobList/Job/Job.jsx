...
export default function Job({ job }) {
  ...
  return (
    <div className={classes.job}>
      <div className={classes.jobLeft}>
        <div className={classes.jobImg} style={{ backgroundImage: `url(${noCompany})` }} />



        <div className={classes.jobDetails}>
          <p className={classes.jobTitle} style={{ marginTop: "0px", fontWeight: "bold" }}>job.job_title</p>
          <p>job.employer_name</p>
          <p style={{ color: "gray" }}>job.job_city , job.job_country</p>
          <p style={{ color: "gray" }}>"On-Site"</p>
          <p style={{ marginBottom: "0px", fontSize: "12px" }}>10 Days Ago</p>
        </div>
      </div>
